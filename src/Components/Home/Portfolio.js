...
const Portfolio = () => {
    return (
        <div className='mt-0 bg-teal-100' id='portfolio'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 py-16 lg:pl-40 pl-16'>
                ...
                <div class="card w-96 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="text-center text-2xl font-medium">Cyber Doctor!</h2>
                        <img src={cyberDoctor} alt="" />
                        <p>This is Independent service Provider Website. in this website user can get any service</p>
                        <div class="flex justify-evenly">
                            <a href='https://github.com/Al-aminhossain1/cyber-doctor' target='_blank' rel='noReferrer'><button class="btn btn-sm btn-primary">Client Repo</button> </a>
                            <a href='https://cyber-doctor.web.app/' target='_blank' rel='noReferrer'><button class="btn btn-sm btn-primary">Preview</button> </a>
                        </div>
                    </div>
                </div>
                <div class="card w-96 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="text-center text-2xl font-medium">Hotel Water blue(Product Analysis)!</h2>
                        <img src={productAnalysis} alt="" />
                        <p>If a dog chews shoes whose shoes does he choose?</p>
                        <div class="flex justify-evenly">
                            <a href='https://github.com/Al-aminhossain1/product-analysis' target='_blank' rel='noReferrer'><button class="btn btn-sm btn-primary">Client Repo</button> </a>
                            <a href='https://amazing-wisp-6d53ac.netlify.app/' target='_blank' rel='noReferrer'><button class="btn btn-sm btn-primary">Preview</button> </a>
                        </div>
                    </div>
                </div>
            </div>
