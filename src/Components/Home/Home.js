    ...
    return (
        <div className=''>
            <div className="card lg:card-side flex justify-evenly bg-teal-100 shadow-xl">
                <figure><img className='w-80 lg:pl-10 rounded-lg' src={alamin} alt="Album" /></figure>
                <div className="px-5 lg:pl-16 pt-5 ">
                    <h1 className='text-xl text-black'>HI THERE</h1>
                    <h2 className=" text-4xl font-semibold  text-black">I'M <span className='text-purple-700'>Md Al Amin Hossain</span></h2>
                    <h1 className='text-black text-xl'>I am Jr. Web DEveloper</h1>
                    <p className='text-black'>An aspiring MERN Stack Developer.I lost myself when I dive into the codes. I am a professional web designer and developer.No project is too big or too small for me. Recently I have completed react and node js. I am expertise in Html5, Css3, Javascript, Bootstrap, Jquery, React JS, Next JS, Node JS, Express JS, Mongo DB.Resourceful Web Developer lends hands-on approach to customizing web presence strategy. More than 1+ years of experience working closely with Web Development to outline organizational needs and translate them into extensive lines of code that support objectives. Adept creation of scripts using HTML, CSS and JavaScript to convey unique branding and promote sales and marketing opportunities. Specialty supporting intricate backend needs and lending assistance throughout webpage lifecycle.</p>

                    <a href={Alamin} download='Md Al Amin Resume of Web Developer.pdf'><button className="btn btn-primary my-4" >Download Resume</button></a>
                    <div className='flex '>
